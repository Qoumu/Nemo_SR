...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--no-filter",
        action="store_true",
        help="Kept for CLI compatibility; this script does not apply silence filtering.",
    )
    parser.add_argument(
        "--filter-top-db",
        type=float,
...
def main() -> None:
    ...
    print(
        "[INFO] Silence filtering is disabled in this calibration builder "
        "(arguments kept only for CLI compatibility)."
    )
